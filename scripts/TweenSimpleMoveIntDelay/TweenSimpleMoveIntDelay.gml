/// @description  TweenSimpleMoveIntDelay(x1,y1,x2,y2,dur,ease,delay)
/// @function  TweenSimpleMoveIntDelay
/// @param x1
/// @param y1
/// @param x2
/// @param y2
...
/// @param ease
/// @param delay
function TweenSimpleMoveIntDelay(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
	...
	TweenDelayPropertySetter(_return[1], TPSetExt(ext_roundxy__, argument0, argument2, argument1, argument3));
