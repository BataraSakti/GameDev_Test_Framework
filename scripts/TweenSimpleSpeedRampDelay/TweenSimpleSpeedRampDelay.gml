/// @description  TweenSimpleSpeedRampDelay(speed1,speed2,dur,ease,delay)
/// @function  TweenSimpleSpeedRampDelay
/// @param speed1
/// @param speed2
/// @param dur
/// @param ease
/// @param delay
function TweenSimpleSpeedRampDelay(argument0, argument1, argument2, argument3, argument4) {
