/// @description  TweenSimpleScaleDelay(x1,y1,x2,y2,dur,ease,delay)
/// @function  TweenSimpleScaleDelay
/// @param x1
/// @param y1
/// @param x2
/// @param y2
...
/// @param ease
/// @param delay
function TweenSimpleScaleDelay(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
	...
	TweenDelayPropertySetter(_return[1], TPSetExt(ext_image_xyscale__, argument0, argument2, argument1, argument3));
