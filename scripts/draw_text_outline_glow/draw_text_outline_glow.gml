/// @description draw_text_outline_glow(x,y,string,back_color,front_color,xscale,yscale,alpha,stroke_px)
/// @function draw_text_outline_glow
/// @param x
/// @param y
/// @param string
/// @param back_color
...
/// @param alpha
/// @param stroke_px
function draw_text_outline_glow(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8) {
	/*
	...
	*/
	...
	var _ca = (1/(argument8+1))*argument7; //Clamps the max fade glow alpha to the passed in alpha.
	...
	//Back layers 
	//8 draws per px out...
	//for(var i = 0; i < min(argument8, 3); i++) { //Clamp glows at 3 px levels out?
	for(var i = 0; i < dtd_sc; i++) {
