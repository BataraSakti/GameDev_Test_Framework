/// @description draw_text_outline_colors_auto(x,y,string,back_color,front_color,xscale,yscale,alpha,max_width,stroke_px,use_glow[, min_scale])
/// @function draw_text_outline_colors_auto
/// @param x
/// @param y
/// @param string
/// @param back_color
