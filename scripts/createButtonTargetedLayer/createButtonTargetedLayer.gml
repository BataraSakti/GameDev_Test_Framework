/// @description createButtonTargetedLayer(x,y,layer,obj,target,target_user_event [, text, parent, parent_callback, button_sprite, start_scale])
...
/// @param  button_sprite
/// @param  start_scale]
function createButtonTargetedLayer() {
	...
	show_debug("Create Object "+string(object_get_name(t__.id))+" in layer - "+string(argument[2]));
	if(argument_count >= 7) {
