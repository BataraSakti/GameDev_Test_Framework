/// @description  TweenSimpleMoveInt(x1,y1,x2,y2,dur,ease)
/// @function  TweenSimpleMoveInt
/// @param x1
/// @param y1
/// @param x2
/// @param y2
/// @param dur
/// @param ease
function TweenSimpleMoveInt(argument0, argument1, argument2, argument3, argument4, argument5) {
	...
	_tween[@ TWEEN.PROPERTY] = TPSetExt(ext_roundxy__, argument0, argument2, argument1, argument3);
