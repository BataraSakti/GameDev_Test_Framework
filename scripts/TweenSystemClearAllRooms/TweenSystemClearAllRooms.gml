/// @description  TweenSystemClearAllRooms()
/// @function  TweenSystemClearAllRooms
function TweenSystemClearAllRooms() {
	...
	// Clear delay queues
	repeat(qs_map_size(_pRoomDelays))
	{
	    var _key = qs_map_find_first(_pRoomDelays);
	    qs_queue_destroy(qs_map_find_value(_pRoomDelays, _key));
	    qs_map_delete(_pRoomDelays, _key);
	}

	// Clear and destroy tweens
	repeat(qs_map_size(_pRoomTweens))
	{
	    var _key = qs_map_find_first(_pRoomTweens);
